...
describe.only("Links", () => {
    ...
    it("Should parse correctly", () => {
        ...
        expect(formatDtext("forum post #1")).eq("<http://localhost/forums/posts/1>\n");
        expect(formatDtext("forumpost #1")).eq("<http://localhost/forums/posts/1>\n");
        expect(formatDtext("forum #1")).eq("<http://localhost/forums/posts/1>\n");
        expect(formatDtext("forum topic #1")).eq("<http://localhost/forums/topics/1>\n");
        expect(formatDtext("topic #1")).eq("<http://localhost/forums/topics/1>\n");
        // expect(formatDtext("forum topic #1/p2")).eq("<http://localhost/forums/topics/1?page=2>\n");
        // expect(formatDtext("topic #1/p2")).eq("<http://localhost/forums/topics/1?page=2>\n");
        expect(formatDtext("category topic #1")).eq("<http://localhost/forums/categories/1>\n");
        expect(formatDtext("category #1")).eq("<http://localhost/forums/categories/1>\n");
